...
**Optional tooling**: Kyverno CLI (1.10+), OPA (0.60+), AJV CLI (8.11+), GNU Make (4.3+), GNU tar (1.34+), rekor-cli (v1.4.0 auto-installed by `tools/rekor_monitor.sh` if absent), act (latest; local GitHub Actions emulation).
