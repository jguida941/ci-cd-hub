...
- OWASP runner now enables OSS Index when no key is present and only disables NVD updates when cached data exists, avoiding long fetches while still producing evidence.
