...
> **WARNING: SUPERSEDED:** This guide is archived. Current mutation testing documentation is in the main test documentation and `docs/development/archive/TEST_REORGANIZATION.md`.
>
> **Status:** Archived  
