...
- [x] Align tool runner evidence + OWASP no-key fallback (autoUpdate retry) + pip-audit project scope (ADR-0077)
...
- [x] Guarantee report artifacts on CI failures (minimal reports + hub repo/ref defaults)
