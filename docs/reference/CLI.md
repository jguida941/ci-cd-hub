...
usage: cihub [-h] [--version]
             {detect,preflight,doctor,scaffold,smoke,smoke-validate,check,verify,ci,run,report,triage,docs,adr,config-outputs,discover,dispatch,hub-ci,new,init,update,validate,setup-secrets,setup-nvd,fix-pom,fix-deps,sync-templates,config}
             ...
