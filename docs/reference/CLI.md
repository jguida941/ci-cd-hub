...
usage: cihub [-h] [--version]
             {detect,preflight,doctor,scaffold,smoke,smoke-validate,check,verify,ci,ai-loop,run,commands,report,triage,fix,docs,adr,config-outputs,discover,dispatch,hub,hub-ci,new,init,update,validate,setup,setup-secrets,setup-nvd,fix-pom,fix-deps,fix-gradle,sync-templates,config,registry,profile,tool,threshold,repo} ...
...
```
usage: cihub check [-h] [--json] [--ai] [--no-ai] [--smoke-repo SMOKE_REPO]
...
options:
  -h, --help            show this help message and exit
  --json                Output machine-readable JSON
  --ai                  Enable AI-assisted analysis (requires Claude CLI)
...
```
usage: cihub commands [-h] {list} ...

positional arguments:
  {list}
    list      List CLI commands and metadata
...
```
usage: cihub commands list [-h] [--json]
...
```
usage: cihub report [-h] [--json] [--ai] [--no-ai]
...
```
usage: cihub report build [-h] [--json] [--ai] [--no-ai] [--repo REPO]
                          [--workdir WORKDIR]
                          [--correlation-id CORRELATION_ID]
...
```
usage: cihub report summary [-h] [--json] [--ai] [--no-ai] --report REPORT
                            [--output OUTPUT] [--write-github-summary]
...
```
usage: cihub report outputs [-h] [--json] [--ai] [--no-ai] --report REPORT
                            [--output OUTPUT]
...
```
usage: cihub report aggregate [-h] [--json] [--ai] [--no-ai]
...
```
usage: cihub report validate [-h] [--json] [--ai] [--no-ai] --report REPORT
                             [--expect {clean,issues}]
...
```
usage: cihub report dashboard [-h] [--json] [--ai] [--no-ai]
                              --reports-dir REPORTS_DIR --output OUTPUT
                              [--format {json,html}]
...
```
usage: cihub report security-summary [-h] [--json] [--ai] [--no-ai]
                                     [--mode {repo,zap,overall}] [--repo REPO]
                                     [--language LANGUAGE]
...
```
usage: cihub report smoke-summary [-h] [--json] [--ai] [--no-ai]
                                  [--mode {repo,overall}] [--owner OWNER]
...
```
usage: cihub report kyverno-summary [-h] [--json] [--ai] [--no-ai]
...
```
usage: cihub report orchestrator-summary [-h] [--json] [--ai] [--no-ai]
...
```
usage: cihub triage [-h] [--json] [--ai] [--no-ai] [--output-dir OUTPUT_DIR]
                    [--report REPORT] [--summary SUMMARY] [--run RUN_ID]
                    [--latest] [--watch] [--interval SECONDS]
                    [--artifacts-dir PATH] [--repo OWNER/REPO]
                    [--workflow NAME] [--branch NAME] [--multi] [--aggregate]
                    [--per-repo] [--reports-dir PATH] [--detect-flaky]
                    [--gate-history] [--min-severity LEVEL] [--category CAT]
                    [--verify-tools]
...
```
usage: cihub dispatch trigger [-h] [--json] [--wizard] --owner OWNER
                              --repo REPO --ref REF [--workflow WORKFLOW]
                              [--correlation-id CORRELATION_ID]
                              [--input INPUTS]
...
options:
  -h, --help            show this help message and exit
  --output, -o OUTPUT   Path to write SARIF output
  --workflows WORKFLOWS
...
options:
  ...
  --min-mutation-score, --min-score MIN_MUTATION_SCORE
...
usage: cihub new [-h] [--json] [--owner OWNER] [--language {java,python}]
                 ...
                 [--interactive] [--config-json CONFIG_JSON |
                 --config-file CONFIG_FILE] [--dry-run] [--yes]
                 name
...
options:
  ...
  --config-json CONFIG_JSON
                        Inline JSON config override (TypeScript wizard
                        handoff)
  --config-file CONFIG_FILE
                        Path to YAML/JSON config override (TypeScript wizard
                        handoff)
...
options:
  ...
  --install-from {pypi,git,local}
                        How cihub should be installed in CI: pypi (default),
                        git, or local
  --hub-repo HUB_REPO   Hub repo (owner/name) for setting HUB_REPO (default:
...
```
usage: cihub config edit [-h] [--json] [--config-json CONFIG_JSON |
                         --config-file CONFIG_FILE]
...
options:
  -h, --help           show this help message and exit
  --output, -o OUTPUT  Output file path (e.g., backup.json)
...
options:
  -h, --help       show this help message and exit
  --file, -f FILE  Input file path (e.g., backup.json)
...
options:
  -h, --help           show this help message and exit
  --output, -o OUTPUT  Output file path (e.g., my-profile.yaml)
  --json               Output machine-readable JSON
```
...
options:
  -h, --help       show this help message and exit
  --file, -f FILE  Input file path (e.g., my-profile.yaml)
...
```
usage: cihub tool enable [-h] [--wizard] [--for-repo NAME | --all-repos |
                         --profile NAME] [--json]
                         [tool]
...
```
usage: cihub tool disable [-h] [--wizard] [--for-repo NAME | --all-repos |
                          --profile NAME] [--json]
                          [tool]
