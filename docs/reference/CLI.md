...
usage: cihub [-h] [--version]
             {detect,preflight,doctor,scaffold,smoke,smoke-validate,check,verify,ci,run,report,triage,fix,docs,adr,config-outputs,discover,dispatch,hub,hub-ci,new,init,update,validate,setup,setup-secrets,setup-nvd,fix-pom,fix-deps,fix-gradle,sync-templates,config,registry}
             ...
...
usage: cihub docs audit [-h] [--json] [--output-dir OUTPUT_DIR]
                        [--skip-references] [--skip-consistency]
                        [--github-summary]
...
usage: cihub hub-ci [-h] [--json]
                    {actionlint-install,actionlint,syntax-check,yamllint,repo-check,source-check,security-pip-audit,security-bandit,security-ruff,security-owasp,docker-compose-check,codeql-build,kyverno-install,trivy-install,trivy-summary,kyverno-validate,kyverno-test,smoke-java-build,smoke-java-tests,smoke-java-coverage,smoke-java-checkstyle,smoke-java-spotbugs,smoke-python-install,smoke-python-tests,smoke-python-ruff,smoke-python-black,release-parse-tag,release-update-tag,ruff,ruff-format,black,mypy,mutmut,coverage-verify,bandit,pip-audit,zizmor-run,zizmor-check,validate-configs,validate-profiles,validate-triage,license-check,gitleaks-summary,badges,badges-commit,pytest-summary,summary,outputs,enforce,verify-matrix-keys,quarantine-check,enforce-command-result}
                    ...
...
```
usage: cihub registry [-h] [--json] {list,show,set,diff,sync,add} ...

positional arguments:
  {list,show,set,diff,sync,add}
...
```
usage: cihub registry diff [-h] [--configs-dir CONFIGS_DIR] [--json]
...
```
usage: cihub registry add [-h] [--tier TIER] [--description DESCRIPTION]
                          [--json]
                          repo
