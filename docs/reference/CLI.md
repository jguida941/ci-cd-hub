...
usage: cihub [-h] [--version]
             {detect,preflight,doctor,scaffold,smoke,smoke-validate,check,verify,ci,run,report,triage,fix,docs,adr,config-outputs,discover,dispatch,hub,hub-ci,new,init,update,validate,setup,setup-secrets,setup-nvd,fix-pom,fix-deps,fix-gradle,sync-templates,config,registry,profile,tool,threshold,repo}
             ...
